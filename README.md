...
| check-unnecessarily-public-code                |          | Run `dcm check-unnecessarily-public-code` ([docs](https://dcm.dev/docs/cli/code-quality-checks/check-unnecessarily-public-code/)).                                                                                                                                                       | `false`                              |
