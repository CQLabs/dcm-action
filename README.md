...
| **### Analyze Assets:**         |          |                                                                                                                                                                                                                                                                                                                            |                                      |
| size                            |          | Size limit for image assets ([docs](https://dcm.dev/docs/cli/analysis/analyze-assets/#images-with-exceeding-size)).                                                                                                                                                                                                        | `500KB`                              |
...
| allowed-formats                 |          | List of allowed formats for particular folders (e.g. `icons:svg`) ([docs](https://dcm.dev/docs/cli/analysis/analyze-assets/#images-in-incorrect-folders-disabled-by-default)).                                                                                                                                             |                                      |
| **### Analyze Widgets:**        |          |                                                                                                                                                                                                                                                                                                                            |                                      |
