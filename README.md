...
| fatal-level                        |          | Treat equal or higher lint issues severity as fatal (unset by default).                                                                                                                                                                                                                                                    |                                      |
| **### Commands:**                  |          |                                                                                                                                                                                                                                                                                                                            |                                      |
...
| check-unnecessarily-public-code    |          | Run `dcm check-unnecessarily-public-code` ([docs](https://dcm.dev/docs/cli/code-quality-checks/unnecessarily-public-code/)).                                                                                                                                                                                               | `false`                              |
| check-unnecessarily-mutable-fields |          | Run `dcm check-unnecessarily-mutable-fields` ([docs](https://dcm.dev/docs/cli/code-quality-checks/unnecessarily-mutable-fields/)).                                                                                                                                                                                         | `false`                              |
...
| statements-threshold               |          | Minimum number of lines for a duplication entry ([docs](https://dcm.dev/docs/cli/code-quality-checks/code-duplication/#configuring-the-minimum-number-of-lines)).                                                                                                                                                          | `3`                                  |
| entries-threshold                  |          | Minimum number of duplication entries to report (since DCM 1.30.0).                                                                                                                                                                                                                                                        | `1`                                  |
| **### Check Dependencies:**        |          |                                                                                                                                                                                                                                                                                                                            |                                      |
